                                                ...
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu pull-left" role="menu">
                                                        ...
                                                        @if(\Auth::user()->isA('super-admin'))
                                                            ...
                                                            <li><a href="#" data-href="{{ URL::route('testimonies.approve', $testimony->id) }}" id="activate{{$index}}"><i class="fa fa-minus-square-o"></i><span class="badge badge-{{ testimony_status($testimony->status,'class') }}">{{ testimony_status($testimony->status,'name') }}</a></li>
                                                        @endif
                                                    </ul>
                                                </div>
                                            </td>
