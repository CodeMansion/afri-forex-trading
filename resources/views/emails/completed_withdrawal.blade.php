                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="left" style="font-family: Nunito, Helvetica, Arial,sans-serif; font-size: 14px; font-weight: normal; line-height: 24px;">
                                            <p style="font-size: 18px; line-height: 24px;font-weight: bold; color: #58595b; margin: 0;">Hello {{ strtoupper($name) }},</p>
                                            <p style="font-size: 18px; line-height: 24px; color: #72808e;">
                                                This is inform you that your processing withdrawal request has been marked has completed.<br/><br/> Please login to your account and verify the withdrawal completion. <br/><br/> Find below the withddrawal details:
                                            </p>
                                            <p style="font-size:17px;color: #72808e;">
                                                <strong>Withdrawal Amount:</strong> ${{ number_format($amount,2) }}<br/>
                                                <strong>Withdrawal Charge:</strong> ${{ number_format($charge,2) }}<br/>
                                                <strong>Total Deduction:</strong> ${{ number_format($total,2) }}
                                            </p>
                                        </td>
                                    </tr>
