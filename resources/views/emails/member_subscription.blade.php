                                ...
                                <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        <td align="left" style="font-family: Nunito, Helvetica, Arial,sans-serif; font-size: 14px; font-weight: normal; line-height: 24px;">
                                            <p style="font-size: 18px; line-height: 24px;font-weight: bold; color: #58595b; margin: 0;">Hi, {{ strtoupper($member) }}</p>
                                            <p style="font-size: 14px; line-height: 24px; color: #72808e;">
                                                Payment Receipt From Afromarket<br/><br/>
                                                AMOUNT PAID:    ${{ number_format($service['amount'],2) }}<br/><br/>
